...
class ConvNet(nn.Module):
    ...
    def __init__(self, in_channels, in_seq_len, ma_window_size):
        ...
        self.conv_layers = nn.Sequential(
            ...
            # nn.ReLU(),
            # nn.Conv1d(in_channels=128, out_channels=5, kernel_size=1, stride=1, padding=2),
            # nn.ReLU()
        )
        ...
        self.fc_layers = nn.Sequential(
            nn.Linear(128 * conv_output_size, 500),  # Adjust the in_features parameter
            # nn.ReLU(),
            # nn.Linear(500, 500),  # You can add more layers if needed
        )
