...
class ConvNet(nn.Module):
    ...
    def __init__(self, in_channels, in_seq_len):
        ...
        self.conv_layers = nn.Sequential(
            nn.Conv1d(in_channels=in_channels, out_channels=240, kernel_size=5, stride=3, padding=2),
            nn.ReLU(),
            nn.Conv1d(in_channels=240, out_channels=120, kernel_size=5, stride=3, padding=2),
            nn.ReLU(),
            nn.Conv1d(in_channels=120, out_channels=50, kernel_size=5, stride=3, padding=2),
            nn.ReLU()
        )
